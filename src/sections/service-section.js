    ...
    <section sx={{ variant: 'section.services' }}>
      <Container sx={styles.containerBox}>
        <Box sx={styles.thumbnail}>
          ...
          <Button sx={styles.videoBtn} onClick={()=> setVideoOpen(true)} aria-label="Play Button"><span><IoIosPlay/></span></Button>
          {/* <Button sx={styles.videoBtn} onClick={handleClick} aria-label="Play Button">
            <span><IoIosPlay/></span>
          </Button> */}
          <Box sx={styles.shapeBox}>
            <Image src={shapePattern} alt="shape"></Image>
          </Box>
        </Box>
      ...
      {/* <ModalVideo channel="youtube" isOpen={videoOpen} videoId="L61p2uyiMSo" onClose={() => setVideoOpen(false)}/> */}
    </section>
  );
}
